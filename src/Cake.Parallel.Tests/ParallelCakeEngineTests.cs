...
using Cake.Core;
using Cake.Parallel.Tests.Fixtures;
using Xunit;

namespace Cake.Parallel.Tests
{
    public class ParallelCakeEngineTests
    {
        public sealed class TheConstructor
        {
            ...
            {
                // Given
                var fixture = new ParallelCakeEngineFixture { Log = null };
        ...
        public sealed class TheRegisterTaskMethod
        {
            ...
            {
                // Given
                var engine = new ParallelCakeEngineFixture().CreateEngine();
        ...
        public sealed class TheRunTargetMethod
        {
            public sealed class WithTarget
            {
                ...
                {
                    // Given
                    var fixture = new ParallelCakeEngineFixture();
        ...
        public sealed class TheSetupEvent
        {
            ...
            public void Should_Raise_Setup_Event()
            {
                ...
                var result = Assert.Raises<SetupEventArgs>(
                    ...
                    handler => engine.Setup -= handler,
                    async () => await engine.RunTargetAsync(fixture.Context, fixture.ExecutionStrategy, "A"));
